...
[agent bot identity governance](https://github.com/qwts/agent-sop/blob/bf072f7ab2ed077af781fdc3f754425c43f197c5/docs/reference/agent-bot-identity.md)
in agent-sop.
...
through `gh`. `gh auth login` precedes this step on every durable host
(`managed-machine` installs and authenticates `gh` before `setup-agent-bot`),
so the credential is already there:

```bash
gh api -H "Accept: application/vnd.github.raw" \
  repos/qwts/qwts-agent-org/contents/governance/organization-profile.json
```

[ENG-0128](https://github.com/qwts/agent-sop/blob/bf072f7ab2ed077af781fdc3f754425c43f197c5/docs/decisions/ENG-0128-agent-bot-runtime-ownership.md) names two
...
`node tools/organization-profile.mjs --write` so the HTTPS document and
...
3. Add or update its row in
   ...
   with `node tools/organization-profile.mjs --write`. Retire old
...
4. Store the App ID and private key in the reviewed `pass-cli` store — the
   ...
   [ENG-0016](https://github.com/qwts/agent-sop/blob/bf072f7ab2ed077af781fdc3f754425c43f197c5/docs/decisions/ENG-0016-agent-pr-bot-identity.md) — and outside
...
([ENG-0016](https://github.com/qwts/agent-sop/blob/bf072f7ab2ed077af781fdc3f754425c43f197c5/docs/decisions/ENG-0016-agent-pr-bot-identity.md)). The service spends
